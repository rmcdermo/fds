...
fds1000_data = pd.read_csv('ftest/andries_1000_devc.csv',skiprows=1)
fds800_data = pd.read_csv('ftest/andries_800_devc.csv',skiprows=1)

T0 = 1273.15
P0  = 101325.0
X0 = "C3H8:1,O2:5,N2:18.8"
tend = 0.1
steps = 1000
...
plt.savefig("plots_p/C3H8_1000Ta.pdf")
plt.close()
...
ax.set_xlabel('Time (s)')
ax.set_ylabel('P (Pa)')
plt.savefig("plots_p/C3H8_1000Pa.pdf")
plt.close()
...
plt.savefig("plots_p/C3H8_1000G1a.pdf")
plt.close()
...
ax.set_xlabel('Time (s)')
ax.set_ylabel('Mole fraction (mol/mol)')
plt.savefig("plots_p/C3H8_1000G2a.pdf")
plt.close()
...
plt.savefig("plots_p/C3H8_800Ta.pdf")
plt.close()
...
ax.set_xlabel('Time (s)')
ax.set_ylabel('P (Pa)')
plt.savefig("plots_p/C3H8_800Pa.pdf")
plt.close()
...
ax.set_xlabel('Time (s)')
ax.set_ylabel('Mole fraction (mol/mol)')
plt.savefig("plots_p/C3H8_800G1a.pdf")
plt.close()
...
ax.set_xlabel('Time (s)')
ax.set_ylabel('Mole fraction (mol/mol)')
plt.savefig("plots_p/C3H8_800G2a.pdf")
plt.close()