...
plt.savefig("plots/1000TNa_a.pdf")
plt.close()
...
ax.set_xlabel('Time (s)')
ax.set_ylabel('P (Pa)')
plt.savefig("plots/1000PNa_a.pdf")
plt.close()
...
plt.savefig("plots/1000G1Na_a.pdf")
plt.close()
...
ax.set_xlabel('Time (s)')
ax.set_ylabel('Mole fraction (mol/mol)')
plt.savefig("plots/1000G2Na_a.pdf")
plt.close()
...
ax.set_xlabel('Time (s)')
ax.set_ylabel('Mole fraction (mol/mol)')
plt.savefig("plots/1000G3Na_a.pdf")
plt.close()
...
plt.savefig("plots/800TNa_a.pdf")
plt.close()
...
ax.set_xlabel('Time (s)')
ax.set_ylabel('P (Pa)')
plt.savefig("plots/800PNa_a.pdf")
plt.close()
...
ax.set_xlabel('Time (s)')
ax.set_ylabel('Mole fraction (mol/mol)')
plt.savefig("plots/800G1Na_a.pdf")
plt.close()
...
ax.set_xlabel('Time (s)')
ax.set_ylabel('Mole fraction (mol/mol)')
plt.savefig("plots/800G2Na_a.pdf")
plt.close()
...
ax.set_xlabel('Time (s)')
ax.set_ylabel('Mole fraction (mol/mol)')
plt.savefig("plots/800G3Na_a.pdf")
plt.close()