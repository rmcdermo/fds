...
fig, ax = plt.subplots()
ax.plot(Smyth_exp.loc[:,'X'],Smyth_exp.loc[:,'S CH4 7'],'ro',mfc='none',label='Exp CH$_4$  7')
ax.plot(Smyth_fds.loc[:,'X'],Smyth_fds.loc[:,'FDS CH4 7'],'r-',label='FDS CH$_4$  7')
ax.plot(Smyth_exp.loc[:,'X'],Smyth_exp.loc[:,'S CH4 9'],'go',mfc='none',label='Exp CH$_4$  9')
ax.plot(Smyth_fds.loc[:,'X'],Smyth_fds.loc[:,'FDS CH4 9'],'g-',label='FDS CH$_4$  9')
ax.plot(Smyth_exp.loc[:,'X'],Smyth_exp.loc[:,'S CH4 11'],'bo',mfc='none',label='Exp CH$_4$  11')
ax.plot(Smyth_fds.loc[:,'X'],Smyth_fds.loc[:,'FDS CH4 11'],'b-',label='FDS CH$_4$ 11')
...
ax.plot(Smyth_exp.loc[:,'X'],Smyth_exp.loc[:,'S CH3 9'],'bo',mfc='none',label='Exp CH$_3$')
ax.plot(Smyth_fds.loc[:,'X'],Smyth_fds.loc[:,'FDS CH3 9'],'b-',label='FDS CH$_3$')
