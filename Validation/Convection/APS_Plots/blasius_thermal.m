...
for p=1:length(Pr)
    ...
    xlabel('$\eta=z/\sqrt{\nu x/u_0}$','Interpreter','LaTeX','FontSize',Label_Font_Size)
    ylabel('$\frac{T-T_0}{T_w-T_0}=1-\theta$','Interpreter','LaTeX','FontSize',Label_Font_Size)
    axis([0 8 0 1])
...
for p=1:length(Pr)
    ...
    xlabel('T (\circC)','Interpreter',Font_Interpreter,'FontSize',Label_Font_Size)
