...
lh=legend(marker_handle,'Correlation, Nu = C Ra^n','FDS H/\Deltax=8','FDS H/\Deltax=16','FDS H/\Deltax=32','Location','Northwest');
...
print(gcf,'-dpdf','natural_convection_horizontal_enclosure');
