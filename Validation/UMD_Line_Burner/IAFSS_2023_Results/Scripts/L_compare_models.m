...
outdir = '~/blaze_home/rmcdermo/GitHub/FireModels_rmcdermo/fds/Validation/UMD_Line_Burner/IAFSS_2023_Results/PATH_LENGTH_TRI-3/';
pltdir = '../Plots/';
...
HRR0 = importdata([outdir,fuel_name{i_fuel},'_dx_1p25cm_L_2cm_hrr.csv'],',',2);
HRR1 = importdata([outdir,fuel_name{i_fuel},'_dx_1p25cm_L_5cm_hrr.csv'],',',2);
HRR2 = importdata([outdir,fuel_name{i_fuel},'_dx_1p25cm_L_10cm_hrr.csv'],',',2);
HRR3 = importdata([outdir,fuel_name{i_fuel},'_dx_1p25cm_L_20cm_hrr.csv'],',',2);

DEV0 = importdata([outdir,fuel_name{i_fuel},'_dx_1p25cm_L_2cm_devc.csv'],',',2);
DEV1 = importdata([outdir,fuel_name{i_fuel},'_dx_1p25cm_L_5cm_devc.csv'],',',2);
DEV2 = importdata([outdir,fuel_name{i_fuel},'_dx_1p25cm_L_10cm_devc.csv'],',',2);
DEV3 = importdata([outdir,fuel_name{i_fuel},'_dx_1p25cm_L_20cm_devc.csv'],',',2);
...
print(gcf,'-dpdf',[pltdir,fuel_name{i_fuel},'_eta_PATH_LENGTH_1p25cm']);
...
set(gcf,'PaperSize',[Paper_Width Paper_Height]);
set(gcf,'Position',[0 0 Paper_Width Paper_Height]);
print(gcf,'-dpdf',[pltdir,fuel_name{i_fuel},'_global_Chi_R_PATH_LENGTH_1p25cm']);
