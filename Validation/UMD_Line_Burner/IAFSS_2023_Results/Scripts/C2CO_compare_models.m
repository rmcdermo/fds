...
% outdir = '~/blaze_home/rmcdermo/GitHub/FireModels_rmcdermo/fds/Validation/UMD_Line_Burner/IAFSS_2023_Results/FUEL_C_TO_CO_FRACTION/';
% pltdir = '../Plots/';
expdir = 'D:\TRI\macfp-db-master\macfp-db-master\Extinction\UMD_Line_Burner\Experimental_Data\';
% outdir = '../Baseline/';
outdir = 'D:\TRI\UMD\Final_version\FUEL_C_TO_CO_FRACTION\';
%pltdir = '../Plots/';
...
git_tag_ext  = '_dx_1p25cm_C2CO_0_git.txt';

line_fmt = {'r--','g--','b--','k--'};
key_fmt  = {'\gamma=0','\gamma=1/2','\gamma=2/3','\gamma=1'};
...
HRR0 = importdata([outdir,fuel_name{i_fuel},'_dx_1p25cm_C2CO_0_hrr.csv'],',',2);
HRR1 = importdata([outdir,fuel_name{i_fuel},'_dx_1p25cm_C2CO_p5_hrr.csv'],',',2);
HRR2 = importdata([outdir,fuel_name{i_fuel},'_dx_1p25cm_C2CO_TWTH_hrr.csv'],',',2);
HRR3 = importdata([outdir,fuel_name{i_fuel},'_dx_1p25cm_C2CO_1_hrr.csv'],',',2);

DEV0 = importdata([outdir,fuel_name{i_fuel},'_dx_1p25cm_C2CO_0_devc.csv'],',',2);
DEV1 = importdata([outdir,fuel_name{i_fuel},'_dx_1p25cm_C2CO_p5_devc.csv'],',',2);
DEV2 = importdata([outdir,fuel_name{i_fuel},'_dx_1p25cm_C2CO_TWTH_devc.csv'],',',2);
DEV3 = importdata([outdir,fuel_name{i_fuel},'_dx_1p25cm_C2CO_1_devc.csv'],',',2);
...
print(gcf,'-dpdf',[pltdir,fuel_name{i_fuel},'_eta_C2CO_1p25cm']);
...
set(gcf,'PaperSize',[Paper_Width Paper_Height]);
set(gcf,'Position',[0 0 Paper_Width Paper_Height]);
print(gcf,'-dpdf',[pltdir,fuel_name{i_fuel},'_global_Chi_R_C2CO_1p25cm']);
