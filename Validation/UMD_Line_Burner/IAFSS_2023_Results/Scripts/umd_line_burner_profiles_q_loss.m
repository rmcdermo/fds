...
outdir = '../Thermall_Thick_Burner/';

pltdir = '../Plots2/';


F1 = importdata([outdir1,'methane_XO2_18_dx_2p5cm_line.csv'],',',2);
F2 = importdata([outdir1,'methane_XO2_18_dx_1p25cm_line.csv'],',',2);
F3 = importdata([outdir1,'methane_XO2_18_dx_1p25cm_line.csv'],',',2);
F4 = importdata([outdir2,'methane_XO2_18_dx_1p25cm_line.csv'],',',2);
...
lh = legend(H,'Exp','{\it W/dx}=4','{\it W/dx}=8','{\it W/dx}=16');
...
% H(4) = plot(yc3,O2_3,'b--','LineWidth',Line_Width); % dx = 0.625 cm
% xmin = -0.25;
% xmax = 0.25;
% ymin = 0.05;
% ymax = 0.25;
