   ...
   DO J=1,JBAR
      ILOOP: DO I=1,IBAR
         ...
         DZZ_IF: IF ( ANY(ABS(DZZ) > TWO_EPSILON_EB) ) THEN
            ...
            IF (TRI_MODEL .AND. Q_EXISTS) THEN
...
SUBROUTINE COMBUSTION_MODEL(T,DT,ZZ_GET,Q_OUT,MIX_TIME_OUT,CHI_R_OUT,CHEM_SUBIT_OUT,REAC_SOURCE_TERM_OUT,Q_REAC_OUT,&
                            TRI_COR_OUT,TMP_FLAME_OUT,TMP_IN,RHO_IN,MU_IN,DELTA,CELL_VOLUME,IIC,JJC,KKC)
...
REAL(EB) :: ERR_EST,ERR_TOL,A1(1:N_TRACKED_SPECIES),A2(1:N_TRACKED_SPECIES),A4(1:N_TRACKED_SPECIES),ZETA,ZETA_0,&
            ...
            PHI_TILDE,ZZ_FLAME(1:N_TRACKED_SPECIES),H_IN,H_FLAME,ZETA_FLAME,MW_0,MW_FLAME,VOL_FRAC_FLAME,KAPPA_0,KAPPA_FLAME,&
            TRI_NUMER,TRI_DENOM,TMP_FLAME_LOC
...
IF (TRI_MODEL .AND. Q_OUT>TWO_EPSILON_EB) THEN
   ...
   VOL_FRAC_FLAME = MAX(0._EB, MIN(1._EB, ZETA_FLAME * MW_0/MW_FLAME * TMP_FLAME_LOC/TMP_IN ))
   ...
   DO IBND=1,NUMBER_SPECTRAL_BANDS
      ...
      TRI_NUMER = (1._EB-VOL_FRAC_FLAME)*KAPPA_0*TMP_IN**4 + VOL_FRAC_FLAME*KAPPA_FLAME*TMP_FLAME_LOC**4
