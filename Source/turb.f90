...
REAL(EB) :: NUSSELT,Q,ZC,NU_G,D_STAR,ALPHA,THETA_NATURAL,THETA_FORCED,Q_OLD,ERROR,DTMP,PR_L,PR_T,DTDN(3),EXPON_TURB
INTEGER :: ITER,REGIME
...
REAL(EB), PARAMETER :: C_L_FORCED = 0.25_EB, C_T_FORCED = C_L_FORCED*70._EB**(-2._EB/9._EB)
