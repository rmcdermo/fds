...
REAL(EB) :: NUSSELT,Q,ZC,NU_G,D_STAR,ALPHA_G,THETA_NATURAL,THETA_FORCED,Q_OLD,ERROR,DTMP,DTDN(3),EXPON_TURB,&
            PR_G,PR_L_FAC,PR_T_FAC,C_L_FORCED,C_T_FORCED
INTEGER :: ITER,REGIME
...
REAL(EB), PARAMETER :: Z_L_FORCED = 8._EB, Z_T_FORCED = 70._EB
REAL(EB), PARAMETER :: ZLF_MINUS_TWTH = Z_L_FORCED**(-2._EB/3._EB), ZTF_MINUS_TWO_NINETHS = Z_T_FORCED**(-2._EB/9._EB)
INTEGER, PARAMETER :: NATURAL=1, FORCED=2
REAL(EB), PARAMETER :: ONE_NINETH=1._EB/9._EB, EIGHT_NINETHS=8._EB/9._EB
REAL(EB), PARAMETER :: FOUR_TWENTY_SEVENTHS=4._EB/27._EB, SEVEN_TWENTY_SEVENTHS=7._EB/27._EB
...
IF (THETA_FORCED < THETA_NATURAL**2) THEN
   REGIME = FORCED
   PR_L_FAC = PR_G**(-ONE_NINETH)
   PR_T_FAC = PR_G**(-SEVEN_TWENTY_SEVENTHS)
   ! C_L_FORCED=0.25  for PR_G=1, Z_L_FORCED=8
   ! C_T_FORCED=0.097 for PR_G=1, Z_T_FORCED=70
   C_L_FORCED = PR_G**ONE_NINETH * ZLF_MINUS_TWTH
   C_T_FORCED = C_L_FORCED * PR_G**(FOUR_TWENTY_SEVENTHS) * ZTF_MINUS_TWO_NINETHS
ELSE
   REGIME = NATURAL
