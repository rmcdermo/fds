...
REAL(EB) :: NUSSELT,Q,ZC,NU_G,D_STAR,ALPHA_G,THETA_NATURAL,THETA_FORCED,Q_OLD,ERROR,DTMP,DTDN(3),EXPON_TURB,PR_G,&
            C_L_FORCED,C_T_FORCED
INTEGER :: ITER,REGIME
...
REAL(EB), PARAMETER :: EXPON_L_FORCED = 2._EB/3._EB, EXPON_T_FORCED = 0.871_EB !8._EB/9._EB
