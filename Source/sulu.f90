...
public ::   sulu_env, init_superlu, prep_superlu, fact_superlu, solv_superlu, free_superlu, close_superlu, Destroy_CompCol_Matrix, &
...
contains
   ...
   return
   end subroutine close_superlu


end module sulu_wrapper
...
!@endnote
module sulu_num_param
use iso_fortran_env, only : input_unit, output_unit
use sulu_data_arch, only : I4, R8
implicit none
...
contains
   ...
   return
   end subroutine sort_real_1real
   ...
   return
   end subroutine sort_real_2real
   ...
   return
   end subroutine sort_int_1int_1real
   ...
   return
   end subroutine sort_int_1real


end module sulu_sort_arrays
...
use sulu_data_arch,     only : I4, I8, R8, EPS_R8, HIG_R8
use sulu_num_param,     only : OPU, SOLV_MESS, NO_MESS, PRINT_MESS
use sulu_sort_arrays,   only : sort_int_1real, sort_int_1int_1real
...
contains
   ...
   type(MAT_SOLV), intent(inout) :: mat   !! *high level system type*
      ...
      endselect
   return
   end subroutine factorize_solver
   ...
   return
   end subroutine solution_solver
   ...
   return
   end subroutine freefact_solver
   ...
   type(MAT_SOLV), intent(inout), target :: mat   !! *high level system type*
      ...
      select case(mat%slv_t)
         ...
         case(SULU)  ! Compressed row, assembled form: irow, jptr, a_elt
      ...
      endselect
   return
   end subroutine convert_matrice_format
   ...
   return
   end subroutine from_elemental_to_assembled
