...
HTC_MODEL_SELECT: SELECT CASE(SFX%HEAT_TRANSFER_MODEL)
   CASE(DEFAULT_HTC_MODEL,FLAME_HTC_MODEL)
      ...
      IF (SFX%HEAT_TRANSFER_MODEL==FLAME_HTC_MODEL) &
         HEAT_TRANSFER_COEFFICIENT=HEAT_TRANSFER_COEFFICIENT*MAX(1._EB,(TMP_FLAME(IIG,JJG,KKG)-ONE_DX%TMP_F)/(TMP_G-ONE_DX%TMP_F))
