...
WALL_CELL_LOOP: DO IW=1,N_EXTERNAL_WALL_CELLS+N_INTERNAL_WALL_CELLS
   ...
   END SELECT
   B2%U_IMPACT = SQRT(2._EB*HP(BC%IIG,BC%JJG,BC%KKG))
      ...
      HTC_MODEL_SELECT: SELECT CASE(SFX%HEAT_TRANSFER_MODEL)
         CASE(DEFAULT_HTC_MODEL,IMPINGING_JET_HTC_MODEL)
            ...
            IF (SFX%HEAT_TRANSFER_MODEL==IMPINGING_JET_HTC_MODEL) THEN
               ...
               RE = RHO_G*P2X%U_IMPACT*CONV_LENGTH/MU_G
            ...
            ELSE
               HEAT_TRANSFER_COEFFICIENT = MAX(NUSSELT_FORCED,NUSSELT_FREE,NUSSELT_IMPINGE,2._EB*CONV_LENGTH/DN)*K_G/CONV_LENGTH
            ENDIF
         ...
         CASE(RAYLEIGH_HTC_MODEL)
            ...
            CALL GET_SPECIFIC_HEAT(ZZ_G,CP_G,TMP_FILM)
            CALL RAYLEIGH_HEAT_FLUX_MODEL(H_NATURAL,ZSTAR,HTR,DN,P1X%TMP_F,TMP_G,K_G,RHO_G,CP_G,MU_G,P1X%U_TANG,P2X%U_IMPACT)
            P2X%Z_STAR = ZSTAR
